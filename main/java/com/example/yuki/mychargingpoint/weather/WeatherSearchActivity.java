package com.example.yuki.mychargingpoint.weather;
...
public class WeatherSearchActivity extends Activity implements OnWeatherSearchListener {
    ...
    private void init() {
        ...
        SharedHelper sh = new SharedHelper(context);
        Map map = sh.read();
        cityname = map.get("city").toString();
        if(cityname==null){
            cityname = "北京市";
        }
    ...
    public void onWeatherLiveSearched(LocalWeatherLiveResult weatherLiveResult, int rCode) {
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            ToastUtil.show(WeatherSearchActivity.this, "请输入所在城市");
